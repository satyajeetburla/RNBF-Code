...
"""
If slices are saved for RNBF, this script generates slices
...
from rnbf.datasets import sdf_util
from rnbf.eval import metrics, eval_pts, plot_utils
from rnbf.geometry import frustum, transform
...
ours_root = incSDF_root + "res/RNBF/slices/"
