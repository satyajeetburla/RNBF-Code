...
from rnbf.eval import plot_utils
...
def plot_rnbf(
    seqs, ours_root, label="RNBF", color="C0",
...
def main(
    ...
    do_plots(
        plot_rnbf,
        incSDF_root + "/res/RNBF/sdf_supervision/ray/",
        "RNBF + Ray", color="C3")
    do_plots(
        plot_rnbf,
        incSDF_root + "/res/RNBF/sdf_supervision/normal/",
        "RNBF + Normal", color="C4")
    do_plots(
        plot_rnbf,
        incSDF_root + "/res/RNBF/sdf_supervision/pc/",
        "RNBF + Batch distance", color="C0")
    """
    ...
    # do_plots(
    #     plot_rnbf,
    #     incSDF_root + "/res/RNBF/frac_time_perception/0.5/",
    #     "RNBF", color="C0")
    # do_plots(
    #     plot_voxblox,
    ...
    do_plots(
        plot_rnbf, rnbf_dir, axes, "RNBF + Batch distance", color="C0")
...
if __name__ == "__main__":
    ...
    rnbf_dir = incSDF_root + "/results/RNBF/exp0/"
